...
extension PhotosViewController {
    ...
    private func bindCollectionView() {
        ...
        photosCollectionView.rx.willDisplayCell
            ...
            .do(onNext: { (cell, index) in cell.imageView.image = nil })
        ...
        /// On image retrival, 1) stop activity indicator, 2) animate the cell, 3) assign the imge, and 4) add it to cached images
        ...
        viewModel.imageRetrievedError
            ...
            .subscribe(onNext: { [weak self] index in
                if let cell = self?.photosCollectionView.cellForItem(at: IndexPath(item: index, section: 1)) as? PhotoCell {
                    cell.activityIndicator.stopAnimating()
    ...
    private func bindLoadingState() {
        viewModel.isLoadingFirstPage
            ...
            .map { $0 ? "Fetching..." : "Unsplash Photos" }
    ...
    private func bindBottomActivityIndicator() {
        viewModel.isLoadingAdditionalPhotos
            .observeOn(MainScheduler.instance)
            .do(onNext: { self.updateConstraintForMode(loadingMorePhotos: $0) })
